...
#QUESTION 8
I have an outcome, Y, and a predictor, X and fit a linear regression model with Y = β0 + β1X + ε to obtain β0 and β1. What would be the consequence to the subsequent slope and intercept if I were to refit the model with a new regressor, X + c for some constant, c?
